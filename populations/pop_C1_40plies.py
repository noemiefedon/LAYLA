...
40 plies satisfying the design and manufacturing guidelines C1
"""
__version__ = '1.0'
...
n_pop = 50
filename = 'pop_sym_C1_40plies.xlsx'
...
while ipop < n_pop + 1:
    ...
    if ipop == 1:
        ss = np.array([0, 0, 0, 0, 0,  45, 0, 0, 0, 0,  0, -45, 90, 90, 45, 0, 0, 0, 0, -45])
    if ipop == 2:
        ss = np.array([0, 0, 0, 0, 0,  45, 90, 90, 90, 90,  90, -45, 90, 90, 45, 0, 0, 0, 0, -45])
    if ipop == 3:
        ss = np.array([90, 90, 90, 90, 90,  45, 0, 0, 0, 0,  0, -45, 90, 90, 45, 0, 0, 0, 0, -45])
    if ipop == 4:
        ss = np.array([90, 90, 90, 90, 90,  -45, 0, 0, 0, 0,  0, -45, 90, 90, 45, 0, 0, 0, 0, 45])
    if ipop == 5:
        ss = np.array([90, 90, 90, 90, 90,  -45, 90, 90, 90, 90,  90, -45, 90, 90, 45, 0, 0, 0, 0, 45])
    if ipop == 6:
        ss = np.array([90, 90, 90, 90, -45,  -45, 0, 0, 0, 0,  0, -45, 90, 90, 45, 45, 0, 0, 0, 45])
    if ipop == 7:
        ss = np.array([-45, 90, 90, -45, 90,  -45, 0, 0, 0, 0,  0, 45, 90, 90, 45, 0, 0, 0, 0, 45])
    if ipop == 8:
        ss = np.array([90, -45, -45, -45, 90,  -45, 0, 45, 45, 45,  0, -45, 90, 90, 45, 0, 0, 0, 0, 45])
    if ipop == 9:
        ss = np.array([90, -45, 90, -45, 90,  -45, 0, 45, 0, 45, 45,  90, 90, 45, 0, 0, -45, -45, 0, 45])
    if ipop == 10:
        ss = np.array([-45, 90, 45, 45, 90,  45, 0, -45, -45, 0,  0, -45, 90, 45, 45, 0, 0, 0, 0, -45])
    if ipop == 11:
        ss = np.array([-45, 0, 45, 45, 90,  45, 0, -45, -45, 90, 90, -45, 0, 45, 45, 0, 0, 0, 0, -45])
    if ipop == 12:
        ss = np.array([-45, 0, 45, 45, 90,  90, -45, 0, 45, 45, 0, 0, 0, 0, -45, 0, 0, 0, 0, -45])
    if ipop == 13:
        ss = np.array([0, -45, 90, 90, 45,  90, -45, 0, 45, 45, 0, 0, 45, 0, -45, 0, 0, 0, 0, -45])
    if ipop == 14:
        ss = np.array([0, -45, 90, 90, -45,  -45, 0, 0, 45, 45,  0, 45, 90, 90, 45,  0, 0, 0, 0, -45])
    if ipop == 15:
        ss = np.array([45, 45, 90, 90, 45, 45, 90, -45, 0, -45, 90, -45, 90, 45, 45, 0, -45, 90, -45, -45,])
    if ipop == 16:
        ss = np.array([45, 45, 0, 0, 45, 45, 90, -45, 0, -45, 90, -45, 90, 45, 45, 0, -45, 90, -45, -45,])
    if ipop == 17:
        ss = np.array([-45, -45, 90, 90, -45, -45, 90, 45, 0, 45, 90, -45, 90, 45, 45, 0, -45, 90, 45, 45,])
    if ipop == 18:
        ss = np.array([45, 45, 90, 90, 45, 0, 0, 0, 0, -45, 90, -45, 90, 45, 45, 0, -45, 90, -45, -45,])
    if ipop == 19:
        ss = np.array([-45, -45, 0, 0, 45, 45, 0, 0, -45, -45, 90, -45, 90, 45, 45, 0, -45, 90, 45, 45,])
    if ipop == 20:
        ss = np.array([45 ,45 , 90 ,-45 , 90, 90 ,45 ,0 ,-45 , -45, -45 , 0, 0 ,45 , 0, 45 ,45 , 0 ,-45 , -45,])
    if ipop == 21:
        ss = np.array([90 ,90 , 90 ,45 , 90, 90 ,45 ,0 ,-45 , -45, -45 , 0, 0 ,45 , 0, 45 ,45 , 0 ,-45 , -45,])
    if ipop == 22:
        ss = np.array([ 90 ,45 ,0 ,-45 , -45, 0, 0, 0 ,45 , 45, 45,45, 0, -45 , 90, -45 ,-45 ,-45 ,90 , 45,])
    if ipop == 23:
        ss = np.array([ 90 ,45 ,90, 90 , -45, 0, 0, 0 ,45 , 45, 0, 0, 0, -45 , 90, -45 ,-45 ,90 ,90 , 45,])
    if ipop == 24:
        ss = np.array([ -45, -45, -45, -45 , -45, 0, 45, 45 ,45 , 45, 45, 90, -45 ,-45 , -45, 0, 45, 45 ,45 , 90,])
    if ipop == 25:
        ss = np.array([ -45, -45, 0, -45 , -45, 0, 0, 45 ,45 , 45, 45, 90, -45 ,-45 , -45, 0, 45, 45 ,45 , 90,])
    if ipop == 26:
        ss = np.array([ -45, -45, 90, 90, -45, 0, 45, 45 ,45 , 0, 45, 90, -45 ,-45 , -45, 0, 45, 0,45 , 90,])
    if ipop == 27:
        ss = np.array([ -45, -45, 90, 90, -45, 0, -45, -45 ,-45 , 0, 45, 90, 45 ,45 ,45, 0, 45, 0,45 , 90,])
    if ipop == 28:
        ss = np.array([ 45, 45, 90, 90, 45, 0, -45, -45 ,-45 , 0, 45, 90, -45 ,-45 ,-45, 0, 45, 0, 0, 45,])
    if ipop == 29:
        ss = np.array([0, 45, 90, -45, -45, -45 ,90 ,45 ,90 , 45, 90 , -45, -45 ,0 , 0, 0 ,45 ,45 ,90 , 90,])
    if ipop == 30:
        ss = np.array([ 45, 45, 90, 90, -45, 0, -45, -45 ,-45 , 0, 45, 90, -45 ,-45 ,90, 45, 45, 0,45 , 90,])
    if ipop == 31:
        ss = np.array([ 0, -45, 90, -45 , -45, 0, 45, 45 ,45 , 45, 90, -45, -45 ,-45 , -45, 0, 45, 45 ,45 , 90,])
    if ipop == 32:
        ss = np.array([0, 45, 45 ,45 , 45, 0, -45, 90, -45 , -45, 90, -45, -45 ,-45 , -45, 0, 45, 45 ,45 , 90,])
    if ipop == 33:
        ss = np.array([90, -45, -45 ,-45 , -45, 0, 45, 45 ,45 , 45, 0, -45, 90, -45 , -45,  0, 45, 45 ,45 , 90,])
    if ipop == 34:
        ss = np.array([ -45, -45, -45, -45 , 0, -45, -45 ,-45 , -45, 0, 45, 45 ,45 , 45, 90, 45, 45 ,45 , 45, 90,])
    if ipop == 35:
        ss = np.array([ -45, -45, -45, -45 , 0, 45, 45 ,45 , 45, 90, -45, -45 ,-45 , -45, 0, 45, 45 ,45 , 45, 90,])
    if ipop == 36:
        ss = np.array([90, -45, -45, -45 , 0, 45, 90 ,45 , 45, 90, -45, -45 ,-45 , -45, 0, 45, 45 ,45 , 45, 90,])
    if ipop == 37:
        ss = np.array([ -45, 90, 90, -45 , 0, 45, 45 , 0, 0, 0, 45, 45 ,45 , 45, 90, -45, -45 ,-45 , -45, 90,])
    if ipop == 38:
        ss = np.array([ -45, 90, -45, -45 , 0, 45, 45 , 0, 45, 0, 45, 0, 0 , 45, 90, 90, 90 ,-45 , -45, 90,])
    if ipop == 39:
        ss = np.array([   45, 45 , 0, 45, 0, -45, 90, 90, -45, -45 , 0, -45 , -45, 90, 45, 0, 0 , 45, 90, 90 ,])
    if ipop == 40:
        ss = np.array([   -45 , 0, -45 , -45, 90, 45, 45 , 0, 45, 0, -45, 90, 90, 45, 45, 0, 0 , -45, 0, 0 ,])
    if ipop == 41:
        ss = np.array([   -45, -45 , 90, 45, 90, -45, 90, 90, -45, -45 , 0, 45 , 45, 90, 45, 0, 0 , 45, 90, 90 ,])
    if ipop == 42:
        ss = np.array([   45 , 0, -45 , -45, 90, 45, 90, -45, 0, 0, 0, 0, 45, 45, 0, 45, 0 , -45, -45, 0 ,])
    if ipop == 43:
        ss = np.array([90, 45, 45 ,45 , 45, 0, -45, 90, -45 , -45, 90, 90, -45, 0, 0, -45, -45, 0, 45, 45 ])
    if ipop == 44:
        ss = np.array([90, 45, 0, 0, 45, 0, -45, 90, -45 , 90, 90, 90, 45, 0, 0, -45, -45, 0, 0, 45 ])
    if ipop == 45:
        ss = np.array([0, 0, 0, 0, 45, 0, -45, 90, -45 , 0, 0, 0, 45, 0, 0, 45, 90, 90, -45, 0 ])
    if ipop == 46:
        ss = np.array([0, 0, 0, 0, 45, 90, -45, 90, -45 , 0, 45, 45, 0, 0, 45, 90, 90, 90, -45, -45 ])
    if ipop == 47:
        ss = np.array([0, 45, 0, 0, 45, 90, -45, 0, -45 , 0, 45, 45, 0, 0, 45, 90, -45, 90, -45, -45 ])
    if ipop == 48:
        ss = np.array([0, 45, 90, 90, 45, 90, -45, 0, -45 , 0, 45, 45, 90, 90, 45, 90, -45, 90, -45, -45 ])
    if ipop == 49:
        ss = np.array([90, 90, 90, 90, 45, 90, -45, 0, -45 , 0, 45, 45, 90, 90, 45, 90, -45, 90, 90, -45 ])
    if ipop == 50:
        ss = np.array([90, 45, 0, 0, 45, 90, -45, 90, -45 , 90, 90, 90, 45, 0, 0, -45, -45, 90, 90, 45 ])
    if ipop == 51:
    ...
    if ipop == 57:
        ss = np.array([0, 45, 0, 0, 0, 0, 0, 0, 0, 45, -45, 90, 90, 0, -45, 90, 0, 45, 0, 90, ])
    if ipop == 58:
