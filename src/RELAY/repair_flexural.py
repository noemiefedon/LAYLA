...
def repair_flexural(
        ...
        out_of_plane_coeffs,
        parameters,
        multipanel=None, lampam_target=None,
        reduced_pdl=None, reduced_sst=None, reduced_lampam=None,
        reduced_ss=None, mat=None, repair_flexural_for_ref_panel_only=True,
        count_obj=False):
    """
    repair for flexural properties
